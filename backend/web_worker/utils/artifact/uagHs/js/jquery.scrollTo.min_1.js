<!DOCTYPE html><html lang="en"><head>
    ...
    <script src="jquery.min_8.js"></script>
    <script src="bootstrap.min_8.js"></script>
...
<body style="zoom: 1;">
    ...
    <link rel="stylesheet" type="text/css" href="../css/bootstrap.min_8.css">

    <link rel="stylesheet" type="text/css" href="../css/main_8.css">

    <link rel="shortcut icon" type="image/x-icon" href="../favicon.ico">
    <link rel="shortcut icon" type="image/x-icon" href="../favicon.ico">

    <script async src="jquery.min_8.js"></script>
    <script async src="bootstrap.min_8.js"></script>
    <script async src="typed.min_8.js"></script>
    <script async asrsrc="assets/vendors/three/build/three.min.js"></script>
    <script async src="jquery.scrollTo.min_8.js"></script>
    <script async src="tether.min_8.js"></script>
                    ...
                    <div class="col-xs-3">
                        <div class="cwt__logo cwt__logo--small">
                            <a href="index.html" class="logo1">
                                <img class="logo1" src="../images/Capture-min.JPG_8.jpg" alt="Alan Wu">
                            </a>
                        </div>
                    </div>
                    <div class="col-xs-9">
        ...
        <div class="row">
            <div class="cwt__block cwt__main-header" style="display: none;">
                <div class="row">
                    <div class="col-xs-3">
                        <div class="cwt__logo">
                            <a href="index.html"> <img src="../images/logo_8.png" alt="Clean UI Admin Template + Free Ultimate Premium Bundle + Landing Pages + BEM + Angular2 Starter Kit">
                            </a>
                        </div>
                    </div>
                    <div class="col-xs-9">
            ...
            <div class="cwt__block cwt__features">
                ...
                <div class="row" style="text-align: center;">
                    ...
                    <div class="container">
                        <video playsinline loop controls preload="auto" id="mybfVideo" style="outline: 0; display:none;">
                            <source src="../media/bf_8.mp4" type="video/mp4">
                        </video>
                    </div>
                ...
                <div class="cwt__features__container">
                    ...
                    <video class="videoisme" muted autoplay playsinline loop preload="auto" id="myVideo" style="visibility:visible;">
                        <source src="../media/vid%20copy_8.mp4" type="video/mp4">
                    </video>
                </div>
            </div>
                ...
                <div class="cwt__showcase__devices">
                    <div class="cwt__showcase__laptop">
                        ...
                        <div class="cwt__showcase__laptop__bg">
                            <div class="cwt__showcase__box"> <img src="../images/laptop_8.gif" class="cwt__showcase__box__gif"> </div>
                        </div>
                    </div>
                    <div class="cwt__showcase__mobile hidden-sm-down">
                        <div class="cwt__showcase__box"> <img src="../images/brain1_8.gif" class="cwt__showcase__box__gif" alt="Coming Up"> </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cwt__block cwt__promo hidden-md-down">
                <div class="cwt__promo__images cwt__promo__images--showed">
                    <a href="javascript: void(0);" class="cwt__promo__images__img cwt__promo__images__img--1"> <img src="../images/promo_1_8.jpg" alt> </a>
                    <a href="javascript: void(0);" class="cwt__promo__images__img cwt__promo__images__img--1"> <img src="../images/promo_1_8.jpg" alt> </a>
                    <a href="javascript: void(0);" class="cwt__promo__images__img cwt__promo__images__img--1"> <img src="../images/promo_1_8.jpg" alt> </a>
                    <a href="javascript: void(0);" class="cwt__promo__images__img cwt__promo__images__img--2"> <img src="../images/promo_2_8.jpg" alt> </a>
                    <a href="http://www.pacificfreshproduce.com/" target="_blank" class="cwt__promo__images__img cwt__promo__images__img--3"> <img src="../images/PFP.JPG_8.jpg" alt> </a>
                    <a href="javascript: void(0);" class="cwt__promo__images__img cwt__promo__images__img--4"> <img src="../images/Capture.JPG_8.jpg" alt> </a>
                    <a href="javascript: void(0);" class="cwt__promo__images__img cwt__promo__images__img--5"> <img src="../images/Capture1.JPG_8.jpg" alt> </a>
                </div>
            </div>
            ...
            <div class="cwt__block cwt__gallery">
                ...
                <div class="cwt__gallery__container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <a href="https://asianglow-index.com/" target="_blank" class="cwt__gallery__item"> <img src="../images/brain2_8.gif" alt="Ml" class="cwt__gallery__item__img">
                        ...
                        <div class="col-md-4">
                            <a href="https://www.pacificfirstaid.ca/" class="cwt__gallery__item">
                                <img src="../images/PFA1_8.gif" alt="Loading" class="cwt__gallery__item__img">
                        ...
                        <div class="col-md-4">
                            <a href="https://kiosk.alan-wu.com/" class="cwt__gallery__item"> <img src="../images/PFP_8.gif" alt="Loading" class="cwt__gallery__item__img"><span class="btn btn-primary cwt__gallery__item__btn">Under maintenance ... </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="https://kiosk.alan-wu.com/" target="_blank" class="cwt__gallery__item"> <span class="btn btn-primary cwt__gallery__item__btn">Click
                                    for Live Preview</span><img src="../images/ezgif.com-resize_8.gif" alt="Loading" class="cwt__gallery__item__img">
                                <div class="cwt__gallery__item__overlay"></div>
                        ...
                        <div class="col-md-4">
                            <a href="https://github.com/alanwu4321" target="_blank" class="cwt__gallery__item"> <span class="btn btn-primary cwt__gallery__item__btn">In Progress ... </span><img src="../images/rych_8.png" alt="Loading" class="cwt__gallery__item__img">
                                <div class="cwt__gallery__item__overlay"></div>
                        ...
                        <div class="col-md-4">
                            <a href="https://github.com/alanwu4321" target="_blank" class="cwt__gallery__item"> <span class="btn btn-primary cwt__gallery__item__btn">In Progress ... </span><img src="../images/chatbot_8.png" alt="Loading" class="cwt__gallery__item__img">
                                <div class="cwt__gallery__item__overlay"></div>
