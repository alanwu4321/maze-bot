...
class ProductDemand(Resource):
    ...
    get_parser.add_argument('date', type=str, help='product name', location='args')
    get_parser.add_argument('demand', type=float, help='created by', location='args')

    post_parser = reqparse.RequestParser()
    post_parser.add_argument('p_id', type=int, help='product id', location='form')
    post_parser.add_argument('date', type=str, help='product model number', location='form')
    post_parser.add_argument('demand', type=float, help='product category', location='form')
    ...
    def get(self):
        ...
        rows.order_by(args.pop('col'), args.pop('ord'))
